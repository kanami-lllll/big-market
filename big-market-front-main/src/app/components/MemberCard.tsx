...
export function MemberCard({allRefresh}) {
    ...
    const queryUserCreditAccountHandle = async () => {
        const result = await queryUserCreditAccount(getDemoUserId());
    ...
    const calendarSignRebateHandle = async () => {
        ...
        const result = await calendarSignRebate(getDemoUserId());
    ...
    const isCalendarSignRebateHandle = async () => {
        ...
        const result = await isCalendarSignRebate(getDemoUserId());
